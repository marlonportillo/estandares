...
if (headers_sent()) {
    die("  Location: http://localhost/Presupuestos/mainoperador.php?module=segui_detalle&id=5 ");
}
else{
    exit(header("Location: http://localhost/Presupuestos/mainoperador.php?module=segui_detalle&id=$idpre" ));
}
}
