...
if ($estado != 1 ) 
{
	...
	if ($estado == 2) {
		...
		echo " El presupuesto  fue Rechazado <a href=mainadmin.php?module=listpresu>back </a>";
	}
	else
	{
	...
	$sqlquery2 = "UPDATE presupuesto SET estado = 1 where id_presupuesto = $id" ; 
			...
			if (headers_sent()) {
			    die("   Please click on this link: <a href=mainadmin.php?module=listpresu>back </a>");
			}
			else{
...
{
	echo " El presupuesto ya fue elvaluado <a href=mainadmin.php?module=listpresu>back </a>";
}
