...
<form method="POST" action="mainadmin.php?module=seguimiento" >
...
$result = sqlsrv_query($conn,$sqlquery);
 while($row = sqlsrv_fetch_array($result)){
  ...
  <td>
                ...
                <a href="mainadmin.php?module=segui_detalle&id=<?php echo $row['id_presupuesto'];?> " class="btn btn-sm btn-dark">Ver detalle</a>
