...
if($result === false){
	...
	if (headers_sent()) {
	    die(" Datos Registrados correctamente  Please click on this link: <a href=mainadmin.php?module=seguimiento>back </a>");
	}
	else{
	    exit(header("Location: mainadmin.php?module=seguimiento ?>"));
	}
