...
<form method="POST" action="mainadmin.php?module=listpresu" >
...
from 
presupuesto b  
join areas on presu_id_area = id_area
where datepart(year,fecha_publicacion) = $ano
...
if ($result === false) {
 ...
 while($row = sqlsrv_fetch_array($result)){
  ...
  <td>
                ...
                <a href="mainadmin.php?module=detailpresu&id=<?php echo $row['id_presupuesto'];?> " class="btn btn-sm btn-dark">Ver detalle</a>
                 <?php
    if ($row['estado'] == 0) {
        # code...
    ...
    ?>
                <a   href="mainadmin.php?module=evaluatepresu&id=<?php echo $row['id_presupuesto'];?> "  class="btn btn-sm btn-success" >Evaluar</a>
                <a href="mainadmin.php?module=updatepresu&id=<?php echo $row['id_presupuesto'];?> " class="btn btn-sm btn-warning">Modificar</a>
