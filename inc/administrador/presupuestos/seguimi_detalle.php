...
<div class="card">
    <div class="card-body">
        ...
        <h5 class="heading">Detalle</h3>
            ...
            <form method="POST" action="mainadmin.php?module=segui_proc"  enctype="multipart/form-data">
        <table class="table" id="tablapost"  data-pagination="true">
